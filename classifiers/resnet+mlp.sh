#!/bin/bash
#SBATCH -J resnet+mlp  # Job name
#SBATCH -o resnet+mlp.log  # Name of stdout output file (%j expands to jobId)
#SBATCH -e resnet+mlp.err  # Name of stderr output file
...
bash experiments/resnet+mlp_exp.sh